                ...
                <ul class="fields">
                    <div class="Refer_w3l">
                        ...
                        <div class="w3ls-name">	
                            ...
                            <input type="text" class="form-control" name="RegNo" onkeydown="upperCaseF(this)" id="cartextbox_1" placeholder="E.G.: DL01AB1234" pattern="^[a-z|A-Z]{2}[0-9|a-z|A-Z]{1,2}[a-z|A-Z]{1,2}[0-9]{1,4}$" required=" "/>
                        </div>
                        <div class="w3ls-btn">
